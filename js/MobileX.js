...
function fetchRadarImages(){
  ...
  radarImage.setAttribute("src", "https://maps.api.xweather.com/wgE96YE3scTQLKjnqiMsv_SVG2gQFV8y9DjKR0BRY9wPoSLvrMrIqF9Lq2IYaY/flat,radar:75,admin-dk/1230x740/" + latitude + "," + longitude + ",8/current.png");
  radarImage.style.width = "1230px"
  radarImage.style.height = "740px"
  radarImage.style.marginTop = "-120px"
  ...
  if(alertsActive){
    ...
    zoomedRadarImage.setAttribute("src", "https://maps.api.xweather.com/wgE96YE3scTQLKjnqiMsv_SVG2gQFV8y9DjKR0BRY9wPoSLvrMrIqF9Lq2IYaY/flat,radar:75,admin-dk/1230x740/" + latitude + "," + longitude + ",9/current.png");
