...
function wait() {
		 ...
		 fetchStreamedResponse({
			...
			//url            : "https://api.weatherphrase.com/stream/summary/" + lat + "," + lng + "?client_id=wgE96YE3scTQLKjnqiMsv&client_secret=SVG2gQFV8y9DjKR0BRY9wPoSLvrMrIqF9Lq2IYaY&metric=false&limit=3",
			url            : `https://api.weatherphrase.com/stream/summary/${lat}`,
			data           : summaryOptions,
