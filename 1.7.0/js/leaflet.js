...
(this, function (t) {
    ...
    Le = ci.extend({
        ...
        getMinZoom: function () {
            return Math.max(this.options.minZoom, this._layersMinZoom, this.options.crs.minZoom)
        },
        getMaxZoom: function () {
            return Math.min(this.options.maxZoom, this._layersMaxZoom, this.options.crs.maxZoom)
        },
        ...
        _initLayout: function () {
            ...
            Q(t, "leaflet-container" + (qi ? " leaflet-touch" : "") + (Yi ? " leaflet-retina" : "") + (bi ? " leaflet-oldie" : "") + (Bi ? " leaflet-safari" : "") + (this._fadeAnimated ? " leaflet-fade-anim" : ""));
            var i = q(t, "position");
        ...
        _handleDOMEvent: function (t) {
            if (this._loaded && !Mt(t)) {
                var i = t.type;
                "mousedown" !== i && "keypress" !== i && "keyup" !== i && "keydown" !== i || ct(t.target || t.srcElement),
    ...
    var Me = Te.extend({
        ...
        _initLayout: function () {
            ...
            o.href = "#",
            o.title = "Layers",
            qi ? (mt(o, "click", bt), mt(o, "click", this.expand, this)) : mt(o, "focus", this.expand, this),
            e || this.expand(),
        ...
        _addItem: function (t) {
            ...
            t.overlay ? ((i = document.createElement("input")).type = "checkbox", i.className = "leaflet-control-layers-selector", i.defaultChecked = o) : i = this._createRadioElement("leaflet-base-layers_" + n(this), o),
    ...
    Le.include({
        ...
        _updateZoomLevels: function () {
            ...
            this._layersMaxZoom = isFinite(i) ? i : 1 / 0,
            this._layersMinZoom = isFinite(t) ? t : -1 / 0,
            e !== this._getZoomSpan() && this.fire("zoomlevelschange"),
            this.getZoom() > this.getMaxZoom() && this.setZoom(this._layersMaxZoom),
            this.getZoom() < this.getMinZoom() && this.setZoom(this._layersMinZoom)
        }
    });
    var Ge = qe.extend({
        initialize: function (t, i) {
    ...
    var pn = qe.extend({
        ...
        _updateLevels: function () {
            ...
            if (void 0 !== t) {
                ...
                o = this._map;
                return n || ((n = this._levels[t] = {}).el = G("div", "leaflet-tile-container leaflet-zoom-animated", this._container), n.el.style.zIndex = i, n.origin = o.project(o.unproject(o.getPixelOrigin()), t).round(), n.zoom = t, this._setZoomTransform(n, o.getCenter(), o.getZoom()), n.el.offsetWidth, this._onCreateLevel(n)),
                this._level = n,
                n
            }
        },
        ...
        _initTile: function (t) {
            ...
            t.onselectstart = r,
            t.onmousemove = r,
            bi && this.options.opacity < 1 && nt(t, this.options.opacity),
    ...
    Le.addInitHook("addHandler", "doubleClickZoom", Tn),
    Le.mergeOptions({
        dragging: !0,
        inertia: !Mi,
    ...
    Le.addInitHook("addHandler", "dragging", zn),
    Le.mergeOptions({
        keyboard: !0,
        keyboardPanDelta: 80
    });
    ...
    Le.addInitHook("addHandler", "keyboard", Mn),
    Le.mergeOptions({
        scrollWheelZoom: !1,
    ...
    Le.addInitHook("addHandler", "scrollWheelZoom", Cn),
    Le.mergeOptions({
        tap: !0,
        tapTolerance: 15
    });
    ...
    qi && !Vi && Le.addInitHook("addHandler", "tap", Sn),
    Le.mergeOptions({
        touchZoom: qi && !Mi,
    ...
    Le.addInitHook("addHandler", "touchZoom", Zn),
    Le.BoxZoom = Ln,
    Le.DoubleClickZoom = Tn,
    Le.Drag = zn,
    Le.Keyboard = Mn,
    Le.ScrollWheelZoom = Cn,
    Le.Tap = Sn,
    Le.TouchZoom = Zn,
    Object.freeze = ti,
    t.version = "1.4.0+crs-min-max-zoom.d7a7ba1b",
    t.Control = Te,
    t.control = ze,
    t.Browser = Qi,
    t.Evented = ci,
